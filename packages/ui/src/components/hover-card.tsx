...
const hoverCardContentClassVariants = cva(
  'z-50 flex origin-(--transform-origin) flex-col gap-2 border-border-default typo-m13 text-fg-strong border bg-bg-card shadow-popover outline-hidden duration-100 data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
  {
    variants: {
      shape: {
        default: 'rounded-lg',
