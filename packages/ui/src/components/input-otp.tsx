  ...
  'relative flex items-center justify-center transition-all outline-none',
  {
    variants: {
      variant: {
        ...
        auth: 'border-border-default focus:border-primary-blue-1 focus:bg-primary-blue-1/10 text-fg-strong disabled:text-fg-disabled h-12 w-12 rounded-lg border-2 bg-bg-card text-lg font-semibold disabled:bg-bg-card data-[active=true]:border-ring data-[active=true]:ring-ring/50 '
      }
    },
    defaultVariants: {
      variant: 'default'
